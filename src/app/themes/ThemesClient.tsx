      ...
      <Container maxWidth="xl" sx={{ py: { xs: 6, md: 10 } }}>
        <Stack spacing={{ xs: 4, md: 6 }}>
          <ColorGrid title="Палитра" subtitle="Основные цвета из theme.palette (включая дефолтные MUI).">
            ...
            <ColorSwatch label="Text / primary" value={theme.palette.text.primary} textColor={contrast(theme.palette.text.primary)} />
            <ColorSwatch
          ...
          <ColorGrid title="Grey scale" subtitle="theme.palette.grey (шкала серого MUI).">
            {greyKeys.map((k) => (
              <ColorSwatch key={`grey-${k}`} label={`Grey / ${String(k)}`} value={theme.palette.grey[k]} textColor={contrast(theme.palette.grey[k])} />
            ))}
          </ColorGrid>
            ...
            <Paper variant="outlined" sx={{ p: 2.5, borderRadius: 3 }}>
              <Stack spacing={2}>
                ...
                <Stack spacing={0.5}>
                  ...
                  <Typography
                    variant="caption"
                    sx={{ opacity: 0.85, fontFamily: "ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace" }}
                  >
